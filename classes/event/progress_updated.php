...
/**
 * Playback progress updated event.
 *
...
class progress_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventprogressupdated', 'modernvideoplayer');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->relateduserid}' had validated progress saved for modern video player " .
            "activity '{$this->objectid}'.";
    }
}
